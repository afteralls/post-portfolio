...
const fitElementToParent = (el: HTMLElement) => {
...
const sphereAnimation = () => {
  ...
  const breathAnimation = anime({
    ...
    update: (ins: any) => {
      aimations.forEach((animation: any, i) => {
